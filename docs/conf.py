...
# contentrules.slack documentation build configuration file
...
copyright = f"2019 - {year}, Pendect GmbH"
author = "Pendect GmbH"
trademark_name = "Pendect"
now = datetime.now()
year = str(now.year)
...
ogp_site_url = "https://contentrulesslack.readthedocs.io/"
ogp_description_length = 200
ogp_image = "https://contentrulesslack.readthedocs.io/_static/images/icon.png"
ogp_site_name = "contentrules.slack documentation"
ogp_type = "website"
...
html_use_opensearch = "https://contentrulesslack.readthedocs.io/"

html_theme_options = {
    "path_to_docs": "docs",
    "repository_url": "https://github.com/collective/contentrules.slack",
...
html_baseurl = "https://contentrulesslack.readthedocs.io/"

# -- Options for HTML help output -------------------------------------------------

# Output file base name for HTML help builder.
htmlhelp_basename = "ContentRulesSlackDoc"
...
latex_documents = [
    (
        "index",
        "ContentRulesSlackDoc.tex",
        "contentrules.slack documentation",
        "Pendect GmbH",
        "manual",
    ),
]
